...
const { GetUsers, GetUserById, AddMember, AddTrainer, AddSecretary, UpdateTrainer, UpdatesSecretary, UpdateMemberStatus, DeleteSecretary, DeleteTrainer, UpdateMember } = require("../controllers/UserControllers");
...
route.put("/member/:id",UpdateMember)
